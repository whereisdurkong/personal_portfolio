      ...
      ══════════════════════════════ */}
            <section style={{
                ...
                <div style={{
                    ...
                    padding: "clamp(40px,6vw,72px) clamp(24px,6vw,80px) 32px",
                    borderBottom: "0.5px solid rgba(255,255,255,0.05)",
                }}>
                    <div className="av-sr av-section-label" style={{ marginBottom: "24px" }} data-delay="0">Experience</div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", flexWrap: "wrap", gap: "12px" }}>
                        <h2 className="av-sr blur" data-delay="50" style={{
                            fontFamily: "var(--av-serif)", fontSize: "clamp(32px,5vw,60px)",
                            fontWeight: 400, color: "#f5f5f0", letterSpacing: "-0.02em", lineHeight: 1,
                        }}>
                            Work History
                        </h2>
                        <span style={{ fontFamily: "var(--av-mono)", fontSize: "11px", color: "var(--av-g4)" }}>
                            {experience.length} Roles
                        </span>
                    </div>
                </div>

                <ScrollStack itemStackDistance={14} baseScale={0.04} topOffset={250}>
                    {experience.map(({ index, company, role, period, duration, desc, current, award, images, bullets, logo }, i) => (
                        <ScrollStackItem key={role + i} itemClassName="av-exp-item">
                            <div style={{ minHeight: "100vh", padding: "0 clamp(12px,3vw,40px)" }}>
                                <div style={{
                                    position: "sticky", top: `${250 + 14 * i}px`,
                                    background: i % 2 === 0 ? "#242424" : "#383838",
                                    border: "0.5px solid rgba(255,255,255,0.08)",
                                    borderRadius: "24px",
                                    padding: "clamp(36px,5vw,64px)",
                                    minHeight: images?.length ? "520px" : "420px",
                                    display: "flex", flexDirection: "column",
                                    justifyContent: "space-between", gap: "32px",
                                }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                                        <div style={{ flex: 1 }}>
                                            <div style={{ fontFamily: "var(--av-mono)", fontSize: "11px", color: "var(--av-g4)", marginBottom: "20px" }}>
                                                {index}
                                            </div>
                                            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "10px", flexWrap: "wrap" }}>
                                                <span style={{
                                                    ...
                                                    color: "#f5f5f0", fontWeight: 400,
                                                }}>
                                                    {role}
                                                </span>
                                                {current && (
                                                    <span className="av-live-tag" style={{
                                                        fontFamily: "var(--av-mono)", fontSize: "9px", color: "#f5f5f0",
                                                        letterSpacing: "0.1em", border: "0.5px solid rgba(255,255,255,0.3)",
                                                        padding: "2px 8px", textTransform: "uppercase",
                                                    }}>Live</span>
                                                )}
                                                {award && (
                                                    <span style={{
                                                        fontFamily: "var(--av-mono)", fontSize: "9px", color: "var(--av-g4)",
                                            ...
                                            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
                                                ...
                                                <span style={{
                                                    fontFamily: "var(--av-mono)", fontSize: "10px",
                                                    color: "var(--av-g4)", textTransform: "uppercase", letterSpacing: "0.06em",
                                                }}>
                                                    {company}
                                                </span>
                                            </div>
                                            <p style={{
                                                fontFamily: "var(--av-sans)", fontSize: "15px",
                                                fontWeight: 300, color: "rgba(245,245,240,0.45)",
                                                lineHeight: 1.8, maxWidth: "1200px",
                                                marginBottom: bullets?.length ? "20px" : "0",
                                            }}>
                                                {desc}
                                            </p>
                                            {bullets?.length > 0 && (
                                                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "10px", maxWidth: "1200px" }}>
                                                    {bullets.map((b, j) => (
                                                        <li key={j} style={{
                                                            display: "flex", gap: "12px", alignItems: "flex-start",
                                                            fontFamily: "var(--av-sans)", fontSize: "13px",
                                                            fontWeight: 300, color: "rgba(245,245,240,0.38)", lineHeight: 1.7,
                                                        }}>
                                                            <span style={{
                                                                flexShrink: 0, width: "4px", height: "4px",
                                                                borderRadius: "50%", background: "rgba(255,255,255,0.2)", marginTop: "9px",
                                                            }} />
                                                            {b}
                                                        </li>
                                                    ))}
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "8px", paddingLeft: "32px", flexShrink: 0 }}>
                                            <span style={{ fontFamily: "var(--av-mono)", fontSize: "11px", color: "var(--av-g4)", whiteSpace: "nowrap" }}>{period}</span>
                                            <span style={{ fontFamily: "var(--av-mono)", fontSize: "10px", color: "rgba(255,255,255,0.2)" }}>{duration}</span>
                                        </div>
                                    </div>
                                    ...
                                    {images?.length > 0 && (
                                        <div>
                                            <div style={{
                                                fontFamily: "var(--av-mono)", fontSize: "9px",
                                                letterSpacing: "0.14em", textTransform: "uppercase",
                                                color: "var(--av-g4)", marginBottom: "14px",
                                                paddingBottom: "10px",
                                                borderTop: "0.5px solid rgba(255,255,255,0.06)", paddingTop: "24px",
                                            }}>
                                            ...
                                            <div style={{
                                                ...
                                                {images.map((src, j) => (
                                                    <div key={j} style={{
                                                        ...
                                                        height: images.length === 1 ? "280px" : "180px",
